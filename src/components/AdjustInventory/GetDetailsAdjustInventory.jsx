...
import NewAdjustInventoryInvoice from "../Invoice/NewAdjustInventoryInvoice";
      ...
      <Col span={24} className="mt-2">
        ...
        <Card
          ...
          extra={
            <>
              {adjustInventory && (
                <NewAdjustInventoryInvoice
                  title="Adjust Inventory Slip"

...
const DashboardCard = ({ information, count, isCustomer, title }) => {
  ...
  return (
    <Fragment>
      <section className="grid sm:grid-cols-2 xl:grid-cols-8 gap-6 mt-5 mb-5">
        ...
        <div className="ant-shadow w-[120px] sm:w-[120px] lg:w-[150px] relative sm:p-2 dark:bg-[#2e2d35] flex sm:justify-center items-center md:p-6 p-2 bg-white rounded-lg dashboard-card-bg">

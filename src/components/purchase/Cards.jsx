...
import { FaMoneyBillTransfer, FaMoneyBillTrendUp, FaMoneyBills } from "react-icons/fa6";
            ...
            <Tooltip
              title={
                <span className="text-lg">
                  ...
                  />
                  {information?.totalReturnAmount?.toFixed(3)}
                </span>
              }
            >
              <span className="block text-blue-600 text-2xl sm:text-3xl font-bold sm:text-center">
                ...
                />
                {information?.totalReturnAmount
                  ? abbreviateNumber(information?.totalReturnAmount)
                  : 0}
              </span>
              <span className="uppercase sm:text-[14px] block font-semibold sm:font-bold sm:mt-2 dark:text-yellow-100 ">
                {" "}
